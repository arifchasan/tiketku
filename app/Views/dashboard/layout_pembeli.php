	...
	<nav class="vertical_nav">
		<div class="left_section menu_left" id="js-menu">
			<div class="left_section">
				<ul>
					<li class="menu--item">
						<a href="<?= base_url('dashboard/pembeli') ?>" class="menu--link" title="Dashboard" data-bs-toggle="tooltip" data-bs-placement="right">
							<i class="fa-solid fa-gauge menu--icon"></i>
							<span class="menu--label">Dashboard</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="<?= base_url('dashboard/pembeli/tiket') ?>" class="menu--link" title="Events" data-bs-toggle="tooltip" data-bs-placement="right">
							<i class="fa-solid fa-calendar-days menu--icon"></i>
							<span class="menu--label">Tiket</span>
						</a>
					</li>
					<li class="menu--item">
						<a href="<?= base_url('dashboard/pembeli/profile') ?>" class="menu--link" title="Profil" data-bs-toggle="tooltip" data-bs-placement="right">
