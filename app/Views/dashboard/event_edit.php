										...
										<div class=" p-4">
											...
											<form method="POST" enctype="multipart/form-data">
												...
												<div class="form-group mt-4">
												    ...
												    <img src="<?= base_url('uploads/'.$post['gambar']) ?>" height="100">
												</div>
												<div class="form-group mt-4">
												    <label>Lokasi Event</label>
												    <input type="text" class="form-control" name="lokasi" value="<?= set_value('lokasi', $post['lokasi']) ?>">
												</div>
												<div class="form-group mt-4">
												    <label>Waktu</label>
												    <input type="datetime-local" class="form-control" name="waktu" value="<?= set_value('waktu', $post['waktu']) ?>">
												</div>
												<div class="form-group mt-4">
												    <label>Deskripsi</label>
												    <textarea id="summernote" name="deskripsi"><?= set_value('deskripsi', $post['deskripsi']) ?></textarea>
												</div>
												<div class="form-group mt-4">
