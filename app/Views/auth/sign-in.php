				...
				<div class="container">
					<div class="row justify-content-center">
						<div class="col-lg-10 col-md-10">
							<div class="app-top-items">
								...
								<div class="app-top-right-link">
									Belum memiliki akun?<a class="sidebar-register-link" href="<?= base_url('sign-up'); ?>">Sign up</a>
								</div>
							</div>
						</div>
						<div class="col-xl-5 col-lg-6 col-md-7">
							<div>
								<form method="POST">
									<h2 class="registration-title">Masuk ke TiketKu</h2>
									...
									<div class="form-group mt-5">
										...
										<input class="form-control h_50" type="email" name="email" placeholder="Masukan email" value="">																								
									</div>
									<div class="form-group mt-4">
										<div class="field-password">
											<label class="form-label">Kata Sandi*</label>
											<a class="forgot-pass-link" href="<?= base_url('forgot-password'); ?>">Lupa Kata Sandi?</a>
										</div>
										<div class="loc-group position-relative">
											<input class="form-control h_50" type="password" name="password" placeholder="Masukan kata sandi">
										</div>
									</div>

									<input class="main-btn btn-hover w-100 mt-4" type="submit" name="submit" value="submit">
								</form>
								
								<div class="new-sign-link">
									Belum memiliki akun?<a class="signup-link" href="<?= base_url('sign-up'); ?>">Sign up</a>
								</div>
							</div>							
						</div>
					</div>
